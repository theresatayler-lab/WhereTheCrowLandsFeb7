            ...
            <OrnateCard hover={false}>
              ...
              <div className="space-y-6">
                <div className="border-l-2 border-gold/40 pl-4">
                  <h3 className="font-cinzel text-lg text-crimson-bright mb-2 flex items-center gap-2"><img src="/icons/guides/guide-shigg.png" alt="Shigg" className="w-10 h-10 rounded-full object-cover border border-gold/30" /> Shigg</h3>
                ...
                <div className="border-l-2 border-gold/40 pl-4">
                  <h3 className="font-cinzel text-lg text-crimson-bright mb-2 flex items-center gap-2"><img src="/icons/guides/guide-cathleen.png" alt="Cathleen" className="w-10 h-10 rounded-full object-cover border border-gold/30" /> Cathleen</h3>
                  <p className="font-montserrat text-sm text-cream/80 leading-relaxed">
                ...
                <div className="border-l-2 border-gold/40 pl-4">
                  <h3 className="font-cinzel text-lg text-crimson-bright mb-2 flex items-center gap-2"><img src="/icons/guides/guide-katherine.png" alt="Katherine" className="w-10 h-10 rounded-full object-cover border border-gold/30" /> Katherine</h3>
                  <p className="font-montserrat text-sm text-cream/80 leading-relaxed">
                ...
                <div className="border-l-2 border-gold/40 pl-4">
                  <h3 className="font-cinzel text-lg text-crimson-bright mb-2 flex items-center gap-2"><img src="/icons/guides/guide-theresa.png" alt="Theresa" className="w-10 h-10 rounded-full object-cover border border-gold/30" /> Theresa</h3>
                  <p className="font-montserrat text-sm text-cream/80 leading-relaxed">
