...
import { 
  ...
  OrnateCard, LightOrnateCard, CornerFlourish, PageHeader 
        ...
        <DarkSection className="py-20 px-6">
          <div className="max-w-md mx-auto text-center">
            <OrnateCard hover={false}>
              ...
              <p className="font-montserrat text-silver-mist/80">Please log in to view your profile</p>
              <button
      ...
      <DarkSection className="py-12 sm:py-16 md:py-20 px-4 sm:px-6" variant="warm">
        ...
        <div className="max-w-4xl mx-auto relative z-10">
          <motion.div initial={{ opacity: 0, y: -20 }} animate={{ opacity: 1, y: 0 }} className="text-center">
            ...
            <p className="font-montserrat text-sm text-silver-mist/70">{user.email}</p>
            
            {/* Subscription Badge */}
            {subscriptionStatus && (
              <div className="mt-4 inline-flex items-center gap-2 px-4 py-2 bg-gold/10 border border-gold/30 rounded-sm">
                <Crown className={`w-4 h-4 ${subscriptionStatus.subscription_tier === 'paid' ? 'text-gold' : 'text-silver-mist/50'}`} />
              ...
              <LightOrnateCard hover={false}>
                ...
                <div className="space-y-3">
                  <div className="flex justify-between items-center">
                    <span className="font-montserrat text-sm text-navy-dark/70">Plan:</span>
                    <span className="font-montserrat text-sm text-navy-dark font-medium">
                  ...
                  {subscriptionStatus.subscription_tier === 'free' ? (
                    <>
                      <div className="flex justify-between items-center">
                        <span className="font-montserrat text-sm text-navy-dark/70">Spells Used:</span>
                        <span className="font-montserrat text-sm text-navy-dark">
                          {subscriptionStatus.spells_used} / {subscriptionStatus.spell_limit}
                        </span>
                      </div>
                      <div className="flex justify-between items-center">
                        <span className="font-montserrat text-sm text-navy-dark/70">Remaining:</span>
                    ...
                    <div className="flex justify-between items-center">
                      <span className="font-montserrat text-sm text-navy-dark/70">Total Spells:</span>
                      <span className="font-montserrat text-sm text-crimson font-medium">
                ...
                <div>
                  <div className="flex justify-between items-center">
                    <div>
                      ...
                      <p className="font-montserrat text-sm text-navy-dark">{user.email}</p>
                    </div>
                    <button
                ...
                <form onSubmit={handleUpdateEmail} className="space-y-4">
                  ...
                  <div className="flex gap-2">
                    ...
                    <button
                      ...
                      className="px-3 py-2 border border-gold/40 text-navy-dark/70 rounded-sm font-montserrat text-xs uppercase tracking-wider hover:bg-gold/10"
                    >
                      Cancel
                    </button>
                  </div>
