...
const HandcraftedBanner = ({ onClick }) => {
  return (
    <div className="flex justify-end mb-4">
      <button
        onClick={onClick}
        className="group flex items-center gap-2 px-4 py-2.5 bg-navy-mid/90 hover:bg-navy-mid border border-gold/40 hover:border-gold/60 rounded-full shadow-md hover:shadow-lg transition-colors duration-300"
